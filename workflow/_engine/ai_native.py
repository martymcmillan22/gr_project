...
def _base_command_docs() -> list[dict[str, str]]:
    return [
        ...
        {"command": "semantic-health", "description": "Run deterministic semantic health scan with weekly, monthly, or quarterly profiles"},
        {"command": "semantic-scorecard", "description": "Generate monthly or quarterly semantic governance scorecard artifact"},
        {"command": "semantic-strategy-report", "description": "Publish monthly or quarterly semantic strategy report for governance council"},
