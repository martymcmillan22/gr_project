...
def _base_command_docs() -> list[dict[str, str]]:
    return [
        ...
        {"command": "semantic-health", "description": "Run deterministic semantic health scan with weekly, monthly, quarterly, or annual profiles"},
        {"command": "semantic-drift-forecast", "description": "Generate long-range semantic drift forecast for governance planning"},
        {"command": "semantic-scorecard", "description": "Generate monthly, quarterly, or annual semantic governance scorecard artifact"},
        {"command": "semantic-strategy-report", "description": "Publish monthly, quarterly, or annual semantic strategy report for governance council"},
